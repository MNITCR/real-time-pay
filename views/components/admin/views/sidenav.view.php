<div class="fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu transition-transform">
    <a href="#" class="flex items-center pb-4 border-b border-b-gray-800">
        ...
        <h2 class="font-bold text-2xl">BANKING <span class="bg-[#f84525] text-white px-2 rounded-md">KDMV</span></h2>
    </a>
    <ul class="mt-4">
        ...
        <!-- dashboard -->
        <li class="mb-1 group">
            <a href="./" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md <?= ($_SERVER["REQUEST_URI"] === "/real-time-pay/") ? "bg-gray-800 text-white" : "" ?>">
        ...
        <!-- transfer -->
        <li class="mb-1 group">
            <a href="" class="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md <?= ($_SERVER["REQUEST_URI"] === "/real-time-pay/transfer") ? "bg-gray-800 text-white" : "" ?> sidebar-dropdown-toggle">
                <i class="ri-arrow-left-right-line mr-3 text-lg"></i>
            ...
            <ul class="pl-7 mt-2 hidden group-[.selected]:block">
                ...
                <li class="mb-4">
                    <a href="transfer" class="text-gray-900 text-sm flex items-center hover:text-red-600 <?= ($_SERVER["REQUEST_URI"] === "/real-time-pay/transfer") ? "text-red-500 font-medium" : "" ?> before:contents-[''] before:w-1 before:h-1 before:rounded-full before:bg-gray-300 before:mr-3">Transfer money</a>
                </li>
                <li class="mb-4">
